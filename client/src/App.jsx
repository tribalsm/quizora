  ...
  return (
    <main className="auth-layout">
      <section className="auth-hero">
        <div className="brand"><img className="brand-logo" src="/quizroom-logo.svg" alt="" /> QuizRoom</div>
      ...
      <section className="auth-panel">
        <form className="auth-card" onSubmit={submit}>
          <div className="mobile-brand brand"><img className="brand-logo" src="/quizroom-logo.svg" alt="" /> QuizRoom</div>
...
function HostRoom({ socket, room, onExit }) {
  ...
  return (
    <main className="live-stage host-stage">
      <div className="live-top"><div className="brand light"><img className="brand-logo" src="/quizroom-logo.svg" alt="" /> QuizRoom live</div><div className="room-code-small">Код <strong>{state.code}</strong></div><SoundToggle /><Button variant="danger" onClick={() => emit("host:finish")}>Завершить</Button></div>
      <ErrorMessage error={error} />
      {!question ? (
